...
SRC_URI = "git://linuxtv.org/v4l-utils.git;branch=master"
SRCREV = "${AUTOREV}"
S = "${WORKDIR}/git"
...
FILES_libv4l += "${libdir}/libv4l*${SOLIBS} ${libdir}/libv4l/*.so ${libdir}/libv4l/plugins/*.so \
                 ${libdir}/libv4l/*-decomp ${libdir}/libdvbv5.so.0*"
...
addtask v4l2_utils_bootstrap before do_configure after do_patch
